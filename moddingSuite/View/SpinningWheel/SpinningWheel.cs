...
public class SpinningWheel : Control
{
    public static readonly DependencyProperty DotCountProperty =
        DependencyProperty.Register("DotCount", typeof(int), typeof(SpinningWheel),
            new FrameworkPropertyMetadata(12, FrameworkPropertyMetadataOptions.AffectsMeasure, OnDotCountChanged));

    public static readonly DependencyProperty DotColorProperty =
        DependencyProperty.Register("DotColor", typeof(Brush), typeof(SpinningWheel),
            new FrameworkPropertyMetadata(new SolidColorBrush(Color.FromArgb(255, 0, 122, 204)),
                FrameworkPropertyMetadataOptions.AffectsRender)); // windows 7 blue

    public static readonly DependencyProperty DotRadiusProperty =
        DependencyProperty.Register("DotRadius", typeof(double), typeof(SpinningWheel),
            new FrameworkPropertyMetadata(3.0, FrameworkPropertyMetadataOptions.AffectsArrange, OnDotRadiusChanged));

    public static readonly DependencyProperty RadiusProperty =
        DependencyProperty.Register("Radius", typeof(double), typeof(SpinningWheel),
            new FrameworkPropertyMetadata(14.0, FrameworkPropertyMetadataOptions.AffectsMeasure, OnRadiusChanged));

    public static readonly DependencyProperty IsSpinningProperty =
        DependencyProperty.Register("IsSpinning", typeof(bool), typeof(SpinningWheel),
            new UIPropertyMetadata(true, OnIsSpinningChanged));

    public static readonly DependencyProperty SpeedProperty =
        DependencyProperty.Register("Speed", typeof(double), typeof(SpinningWheel),
            new UIPropertyMetadata(1.0, OnSpeedChanged));

    public static readonly DependencyProperty DirectionProperty =
        DependencyProperty.Register("Direction", typeof(RotateDirection), typeof(SpinningWheel),
            new UIPropertyMetadata(RotateDirection.CW, OnDirectionChanged));
    ...
    {
        DefaultStyleKeyProperty.OverrideMetadata(typeof(SpinningWheel),
            new FrameworkPropertyMetadata(typeof(SpinningWheel)));
    }
    ...
    {
        SpinningWheel wheel = obj as SpinningWheel;
    ...
    {
        SpinningWheel wheel = obj as SpinningWheel;
        if (wheel != null && e.NewValue != null && wheel.storyBoard != null) wheel.ToggleSpinning((bool)e.NewValue);
    }
    ...
    private static void UpdateEllipses(IEnumerable ellipses, Action<int, Ellipse> updateMethod)
    {
        if (updateMethod != null && ellipses != null)
        {
            ...
            foreach (object child in ellipses)
            {
                ...
                if (ellipse != null) updateMethod(i++, ellipse);
            }
        }
    }
    ...
    {
        Ellipse ellipse = new();
        ellipse.Fill = DotColor;
        ellipse.Width = DotRadius * 2;
        ellipse.Height = DotRadius * 2;
        ellipse.Opacity = counter / (double)DotCount;
    ...
    private void CreateAnimation()
    {
        ...
        if (Direction == RotateDirection.CCW) rotateAnimation.To *= -1;
