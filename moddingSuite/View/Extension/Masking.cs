...
public static class Masking
{
    ...
    {
        if (e.Command == ApplicationCommands.Cut) e.Handled = true;
    }
    ...
    private static void TextBoxPreviewTextInput(object sender, TextCompositionEventArgs e)
    {
        ...
        if (maskExpression.Match(proposedText).Length != proposedText.Length) e.Handled = true;
    }
    ...
    private static void TextBoxPreviewKeyDown(object sender, KeyEventArgs e)
    {
        ...
        else if (e.Key == Key.Back) proposedText = GetProposedTextBackspace(textBox);
    ...
    private static void Pasting(object sender, DataObjectPastingEventArgs e)
    {
        ...
        if (e.DataObject.GetDataPresent(typeof(string)))
        {
            ...
            if (!maskExpression.IsMatch(proposedText)) e.CancelCommand();
        }
        else
        {
            e.CancelCommand();
