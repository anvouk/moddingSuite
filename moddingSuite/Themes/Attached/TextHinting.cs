...
public static class TextHinting
{
    ...
    {
        if (control is TextBoxBase || control is PasswordBox) control.SetValue(ShowWhenFocusedProperty, value);
    ...
    {
        if (control is TextBoxBase || control is PasswordBox) return (bool)control.GetValue(ShowWhenFocusedProperty);
