...
public partial class Editor : Form
{
    ...
    private void buildImage(string path)
    {
        ...
        Stream imgStream =
            assembly.GetManifestResourceStream(assembly.GetName().Name + ".ZoneEditor.Images." + mapName + ".png");
    ...
    {
        if (zoneData.selectedItem != null) panel1.Controls.Remove(zoneData.selectedItem.propertypanel);
