...
public class ColorBlock
{
    ...
    public ColorBlock(uint[] linearImage)
        : this()
    {
        for (uint i = 0; i < 16; i++) Data[(int)i] = new Color32(linearImage[i]);
    }
    ...
    public ColorBlock(ColorBlock block)
        : this()
    {
        for (uint i = 0; i < 16; i++) Data[(int)i] = block.Color(i);
    }
    ...
    //set { _data = value; }
    private static uint colorLuminance(Color32 c)
    {
        return (uint)(c.r + c.g + c.b);
    }

    // Get the euclidean distance between the given colors.
    private static uint colorDistance(Color32 c0, Color32 c1)
    {
    ...
    private void boundsRange(Color32 start, Color32 end)
    {
        ...
        Color32 minColor = new(255, 255, 255);
        Color32 maxColor = new(0, 0, 0);
    ...
    private void boundsRangeAlpha(Color32 start, Color32 end)
    {
        ...
        Color32 minColor = new(255, 255, 255, 255);
        Color32 maxColor = new(0, 0, 0, 0);
