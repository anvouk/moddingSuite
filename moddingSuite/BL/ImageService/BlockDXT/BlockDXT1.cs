...
{
    [FieldOffset(0)] public Color16 col0;
    [FieldOffset(2)] public Color16 col1;

    [FieldOffset(4)] public byte row_1;
    [FieldOffset(5)] public byte row_2;
    [FieldOffset(6)] public byte row_3;
    [FieldOffset(7)] public byte row_4;
    ...
    public void decodeBlock(ColorBlock block)
    {
        ...
        // Decode color block.
        Color32[] color_array = { new(), new(), new(), new() };
    ...
    {
        indices = 0;
        for (uint i = 0; i < 16; i++) indices |= (uint)((idx[i] & 3) << (short)(2 * i));
    }
