...
{
    [FieldOffset(0)] private ulong alpha0_i; // 8
    ...
    [FieldOffset(0)] private ulong alpha1_i; // 16
    ...
    [FieldOffset(0)] private ulong bits0_i; // 3 - 19
    ...
    [FieldOffset(0)] private ulong bits1_i; // 6 - 22
    ...
    [FieldOffset(0)] private ulong bits2_i; // 9 - 25
    ...
    [FieldOffset(0)] private ulong bits3_i; // 12 - 28
    ...
    [FieldOffset(0)] private ulong bits4_i; // 15 - 31
    ...
    [FieldOffset(0)] private ulong bits5_i; // 18 - 34
    ...
    [FieldOffset(0)] private ulong bits6_i; // 21 - 37
    ...
    [FieldOffset(0)] private ulong bits7_i; // 24 - 40
    ...
    [FieldOffset(0)] private ulong bits8_i; // 27 - 43
    ...
    [FieldOffset(0)] private ulong bits9_i; // 30 - 46
    ...
    [FieldOffset(0)] private ulong bitsA_i; // 33 - 49
    ...
    [FieldOffset(0)] private ulong bitsB_i; // 36 - 52
    ...
    [FieldOffset(0)] private ulong bitsC_i; // 39 - 55
    ...
    [FieldOffset(0)] private ulong bitsD_i; // 42 - 58
    ...
    [FieldOffset(0)] private ulong bitsE_i; // 45 - 61
    ...
    [FieldOffset(0)] private ulong bitsF_i; // 48 - 64
    ...
    public void decodeBlock(ColorBlock block)
    {
        ...
        for (uint i = 0; i < 16; i++) block.Data[i].a = alpha_array[index_array[i]];
    }
