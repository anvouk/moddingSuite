...
internal class DDSHelper
{
    ...
    private static readonly LegacyMap[] LegacyMaps =
    {
        ...
        new LegacyMap(PixelFormats.BC2_UNORM_SRGB, ConversionFlags.None,
            DDS.PixelFormat.DXT2), // D3DFMT_DXT2 (ignore premultiply)
        new LegacyMap(PixelFormats.BC3_UNORM_SRGB, ConversionFlags.None,
        ...
        new LegacyMap(PixelFormats.BC4_UNORM, ConversionFlags.None,
            new DDS.PixelFormat(DDS.PixelFormatFlags.FourCC, new FourCC('A', 'T', 'I', '1'), 0, 0, 0, 0, 0)),
        new LegacyMap(PixelFormats.BC5_UNORM, ConversionFlags.None,
            new DDS.PixelFormat(DDS.PixelFormatFlags.FourCC, new FourCC('A', 'T', 'I', '2'), 0, 0, 0, 0, 0)),

        new LegacyMap(PixelFormats.R8G8_B8G8_UNORM, ConversionFlags.None,
            DDS.PixelFormat.R8G8_B8G8), // D3DFMT_R8G8_B8G8
        new LegacyMap(PixelFormats.G8R8_G8B8_UNORM, ConversionFlags.None,
            DDS.PixelFormat.G8R8_G8B8), // D3DFMT_G8R8_G8B8

        new LegacyMap(PixelFormats.B8G8R8A8_UNORM, ConversionFlags.None,
            DDS.PixelFormat.A8R8G8B8), // D3DFMT_A8R8G8B8 (uses DXGI 1.1 format)
        new LegacyMap(PixelFormats.B8G8R8X8_UNORM, ConversionFlags.None,
        ...
        new LegacyMap(PixelFormats.R8G8B8A8_UNORM, ConversionFlags.NoAlpha,
        ...
        new LegacyMap(PixelFormats.R10G10B10A2_UNORM, ConversionFlags.Swizzle,
        ...
        new LegacyMap(PixelFormats.R10G10B10A2_UNORM, ConversionFlags.None,
