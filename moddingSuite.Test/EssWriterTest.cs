...
public class EssWriterTest
{
    ...
    {
        string file = @"C:\Users\enohka\Desktop\teststuff\beep.ess.wav";
        ...
        if (channels != 1)
        {
            Console.WriteLine("Only mono files supported.");
            return;
        }
        ...
        for (int f = 0; f < frn; f++)
        {
            fs.WriteByte((byte)(pred1 >> 8));
            fs.WriteByte((byte)pred1);
            fs.WriteByte((byte)(pred2 >> 8));
            fs.WriteByte((byte)pred2);
            fs.WriteByte((byte)(output >> 8));
            fs.WriteByte((byte)output);
            fs.WriteByte((byte)(vv22 >> 8));
            fs.WriteByte((byte)vv22);
            fs.WriteByte((byte)(sample1 >> 8));
            fs.WriteByte((byte)sample1);
            fs.WriteByte((byte)(sample2 >> 8));
            fs.WriteByte((byte)sample2);
            fs.WriteByte((byte)(vv10 >> 8));
            fs.WriteByte((byte)vv10);
            fs.WriteByte((byte)(C1 >> 8));
            fs.WriteByte((byte)C1);
            fs.WriteByte((byte)(C2 >> 8));
            fs.WriteByte((byte)C2);
            fs.WriteByte((byte)(C3 >> 8));
            fs.WriteByte((byte)C3);
